	        ...
	        try {
	            ...
	            while (true) {
	                ...
	                if ("q".equals(input)) {	// USER WANTS TO EXIT PROGRAM
	                    ...
	                    buffReader.close();
	               		break; //leave buffReader loop. then prog will close connection to mongo server
	                } 
     ...
     //        			System.out.println("Issue #" + issue_id + " has been published.");
	    ...
	    //            		// trigger 3 will set all associated manuscripts to published!	
       			    ...
       			    // we expect: review <manuscript_id> <appropriateness> <clarity> <methodology> <contribution to field> <recommendation>
       			    	...
       			    	// db.feedback.update( { manuscript_id: <manuscript_id>, person_id: <person_id> }, { $set: { appropriateness: <appropriateness>, clarity: <clarity>, methodology: <methodology>, contribution_to_field: <contribution_to_field>, recommendation: <recommendation>, date_completed: <date_completed> } } )
       			    ...
       			    // we expect: status
       			    	...
       			    	// manuscript.find( { "reviewers": person_id } , {_id: 0, manuscript_id: 1, title: 1, man_status: 1, date_submitted: 1} ).forEach(printBlock);
